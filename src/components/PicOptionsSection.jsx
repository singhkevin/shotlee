...
export default function PicOptionsSection() {
  ...
  return (
    <div className="legal-wrapper landing-pic-options-inner">
      <h2 className="section-headline landing-pic-options-title">Pic Options</h2>
      <p className="body-large">
        Shot Lee&apos;s Enhancement Codes unlock specific aesthetic styles and professional looks. Each code applies a curated set of enhancements. With over 1,000 codes available, you can match your exact vision.
      </p>
      <div className="legal-section enhancement-codes-section enhancement-codes-section-first">
        <h3 className="legal-section-title">How Enhancement Codes Work</h3>
        <p className="legal-paragraph">
          When you submit an image, you can optionally specify an Enhancement Code. Our system applies that code&apos;s combination of color grading, contrast, lighting, and compositional refinements.
        </p>
        <p className="legal-paragraph">
          If no code is specified, Shot Lee generates four distinct professional interpretations, each optimized for different styles.
        </p>
      </div>
      <div className="legal-section enhancement-codes-section">
        <h3 className="legal-section-title">Enhancement Codes List</h3>
        ...
        >
          <h4 className="legal-subsection-title">{activeCategory.label}</h4>
        ...
        <p className="legal-paragraph enhancement-codes-footer">
          ...and many more. Over 1,000 Enhancement Codes are available. Enter the code that matches your desired style.
        </p>
      </div>
    </div>
  );
