      ...
      <div className="container">
        <div className="legal-wrapper">
          ...
          <div className="legal-intro">
            <p>This Refund and Cancellation Policy explains your rights regarding refunds and cancellations for Shot Lee's image enhancement service. By purchasing credits, you agree to the terms outlined below.</p>
          </div>
          ...
          <section className="legal-section">
            <h2 className="legal-section-title">2. Refund Eligibility</h2>
            <p className="legal-paragraph">Full refunds are available under the following conditions:</p>
            <ul className="legal-list">
              <li><strong>30-Day Window:</strong> You may request a full refund within 30 days of your credit purchase date.</li>
              <li><strong>Usage Threshold:</strong> You must have used fewer than 20 credits from the purchased package to be eligible for a refund.</li>
              <li><strong>Unused Credits:</strong> Refunds apply only to unused credits. Credits that have been consumed through image enhancements are not refundable.</li>
            </ul>
          </section>
          <section className="legal-section">
            ...
            <p className="legal-paragraph">Refund requests are typically processed within 5-7 business days. Refunds will be issued to the original payment method used for the purchase.</p>
          </section>
          <section className="legal-section">
            <h2 className="legal-section-title">4. Non-Refundable Items</h2>
            <p className="legal-paragraph">The following are not eligible for refunds:</p>
            <ul className="legal-list">
              <li>Credits that have been consumed through image enhancements</li>
              <li>Purchases made more than 30 days ago</li>
              <li>Free credits provided upon account creation</li>
              <li>Credits from packages where 20 or more credits have been used</li>
            </ul>
          </section>
          <section className="legal-section">
          ...
          <section className="legal-section">
            ...
            <p className="legal-paragraph">Shot Lee reserves the right to modify this Refund and Cancellation Policy at any time. Material changes will be communicated via email to registered users with reasonable advance notice. Continued use of the service after changes constitutes acceptance of the updated policy.</p>
          </section>
          <section className="legal-section">
